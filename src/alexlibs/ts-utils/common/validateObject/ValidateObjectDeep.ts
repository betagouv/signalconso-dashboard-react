...
export const getMissingPropertiesDeep = (requiredProperties: Array<string>, object: object): Array<string> => {
  return requiredProperties.filter((path: string) => _get(object, path) === undefined)
}

export const validateObjectDeep = <T extends object>(requiredProperties: Array<string>, object: T): T => {
