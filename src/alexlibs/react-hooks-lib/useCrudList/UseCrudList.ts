...
type UpdateAction<E, PK extends keyof E> = (
  pk: E[PK],
  ...args: any[]
) => Promise<E>
type DeleteAction<E, PK extends keyof E> = (
  pk: E[PK],
  ...args: any[]
) => Promise<void>
...
interface UseCrudList {
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]> },
  ): CrudListR<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]>; c: CreateAction<E> },
  ): CrudListCR<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]>; u: UpdateAction<E, PK> },
  ): CrudListRU<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { c: CreateAction<E>; r: ReadAction<E[]>; u: UpdateAction<E, PK> },
  ): CrudListCRU<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]>; d: DeleteAction<E, PK> },
  ): CrudListRD<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]>; u: UpdateAction<E, PK>; d: DeleteAction<E, PK> },
  ): CrudListRUD<E, PK, CRUD, ERR>
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: {
      r: ReadAction<E[]>
  ...
  <E, PK extends keyof E, CRUD extends CrudParams<E, PK>, ERR = any>(
    pk: PK,
    _: { r: ReadAction<E[]>; c: CreateAction<E>; d: DeleteAction<E, PK> },
  ): CrudListCRD<E, PK, CRUD, ERR>
}
...
export const useCrudList: UseCrudList = <
  E,
  PK extends keyof E,
  CRUD extends CrudParams<E, PK>,
  ERR = any,
>(
  pk: keyof E,
  {
    ...
    u,
    d,
  }: UseCrudParams<E, PK, CRUD['c'], CRUD['r'], CRUD['u'], CRUD['d']>,
) => {
  const {
    entity: list,
    loading: fetching,
  ...
  const remove = async (primaryKey: E[PK]) => {
    try {
      ...
      removeListError.set(primaryKey, e as ERR)
      removingList.delete(primaryKey)
      throw e
    }
  }
  const update: UpdateAction<E, PK> = async (primaryKey, ...args: any[]) => {
    try {
      ...
      set((n) =>
        n!.map((x) => (x[pk] === primaryKey ? { ...x, ...updatedEntity } : x)),
      )
      updatingListError.set(primaryKey, undefined)
      return updatedEntity
    } catch (e) {
      updatingListError.set(primaryKey, e as ERR)
      throw e
    } finally {
  ...
  const removeError = (primaryKey: E[PK]): ERR | undefined =>
    removeListError.get(primaryKey)
  const updateError = (primaryKey: E[PK]): ERR | undefined =>
    updatingListError.get(primaryKey)
