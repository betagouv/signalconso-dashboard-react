...
export const fr = {
  messages: {
    ...
    confirmEmailDesc: 'Veuillez retaper votre adresse email pour confirmer.',
    confirmYourEmail: 'Confirmez votre adresse email',
  ...
  `,
    ...
    reportedPhoneTitle: 'Téléphones signalés',
  ...
  `,
    ...
    emailSSMVMValidation: 'Email invalide. Emails acceptés : *.gouv.fr',
    daily: 'Quotidienne',
