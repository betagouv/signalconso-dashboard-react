...
export const fr = {
  ...
  `,
    ...
    responseDetailsShort: {
      REMBOURSEMENT_OU_AVOIR: 'Remboursement, avoir',
      REPARATION_OU_REMPLACEMENT: 'Réparation, remplacement',
      LIVRAISON: 'Livraison',
      CONSEIL_D_UTILISATION: "Conseil d'utilisation",
      ME_CONFORMER_A_LA_REGLEMENTATION: 'Me conformer',
      ADAPTER_MES_PRATIQUES: 'Adapter mes pratiques',
      TRANSMETTRE_AU_SERVICE_COMPETENT: 'Transmis',
      DEMANDE_DE_PLUS_D_INFORMATIONS: "Besoin d'infos",
      RESILIATION: 'Résiliation',
      PRATIQUE_LEGALE: 'Pratique légale',
      PRATIQUE_N_A_PAS_EU_LIEU: "N'a pas eu lieu",
      MAUVAISE_INTERPRETATION: 'Mauvaise interprétation',
      DEJA_REPONDU: 'Déjà répondu',
      TRAITEMENT_EN_COURS: 'Traitement en cours',
      PARTENAIRE_COMMERCIAL: 'Tiers-parti',
      ENTREPRISE_DU_MEME_GROUPE: 'Entreprise du même groupe',
      HOMONYME: 'Entreprise homonyme',
      ENTREPRISE_INCONNUE: 'Autre entreprise',
