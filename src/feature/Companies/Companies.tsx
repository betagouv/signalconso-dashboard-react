  ...
  return (
    <Page>
      ...
      {connectedUser.isAdmin && (
        <PageTabs>
          <PageTab
            to={siteMap.logged.companies.registered.value}
            label={m.companiesActivated}
          />
          <PageTab
            to={siteMap.logged.companies.toActivate.value}
            label={m.companiesToActivate}
          />
          <PageTab
            to={siteMap.logged.companies.toFollowUp.value}
      ...
      <Routes>
        <Route
          path="/*"
          element={
            <Navigate replace to={siteMap.logged.companies.registered.value} />
          }
        />
        <Route
