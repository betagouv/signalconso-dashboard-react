...
export const ModeEmploiDGCCRF = () => {
  ...
  return (
    <Page size="small">
      <Panel>
        <PanelBody>
          <Typography variant="h4" gutterBottom>1. Base de données</Typography>
          ...
          <div>
            <p className="mt-4">
              ...
              <br/>
              En passant la souris sur un signalement, on peut lire le contenu plus en détails. En cliquant sur une
              ligne, on ouvre la page détaillée relative au signalement.
            </p>
          </div>
          ...
          <div>
            <p>
              Il correspond au traitement du signalement à un instant T.
            </p>

            <ul>
              <li>
                <mark className={css.mark}>Traitement en cours:</mark>
                Il s'agit d'un statut intermédiaire pendant lequel le signalement suit son cours et n'est pas clos.
                C'est notamment la période laissée au professionnel pour prendre connaissance du signalement ou y répondre.
              </li>
              <li>
                <mark className={css.mark}>N.A (non-applicable):</mark>
                Soit les signalements sont rattachés à une URL et donc ne rentrent pas dans le flow classique d'envoi à l'entreprise.
                Soit l'entreprise signalée ne faisait pas partie du périmètre géographique de l’expérimentation au moment du signalement.
                Si la région n'a pas fait partie tout de suite de l'expérimentation, les signalements reçus sur cette période n'ont pas
                été traités et sont classés en N.A.
              </li>
              <li>
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                Un premier courrier papier a été envoyé dès réception du signalement.
                Après 21 jours, nous adressons un nouveau courrier l'incitant à créer son compte.
                Une nouvelle période de 21 jours est lancée, au terme de laquelle nous clôturons le signalement.
              </li>
              <li>
                ...
                nous envoyons un email tous les 7 jours pendant 3 semaines pour inviter le professionnel à faire le nécessaire.
                Au terme de ces relances, le signalement est clôturé.
              </li>
            </ul>
          </div>
          ...
          <div>
            <p> Il suffit de cliquer sur le bouton "Ajouter des informations DGCCRF".
            </p>
          ...
          <Typography variant="h4" gutterBottom>2. Filtres</Typography>
          ...
          <ul>
            ...
            <li>En fonction du rattachement ou non à une entreprise. Si non, le signalement est actuellement rattaché seulement à une URL.</li>
          </ul>

          <p>
            La recherche par mot-clé permet de rechercher une sous-catégorie par exemple.<br/>
            La recherche par mot-clé va rechercher dans l’ensemble du champ «&nbsp;description&nbsp;» et dans le champ
            «&nbsp;problème&nbsp;» (excepté le nom de la catégorie).<br/>
          </p>
          ...
          <Typography variant="h4" gutterBottom>3. Export Excel</Typography>

          <p>
            L’export génère un fichier Excel qui reprend les signalements suivant les filtres appliqués le cas échéant.
            Le fichier Excel comporte les informations suivantes :
          </p>
          ...
          <ul>
            ...
            <li>Accord pour contact ( oui = le consommateur a souhaité laissé visible ses coordonnées auprès du
              professionnel, non = le consommateur a souhaité rester anonyme vis-à-vis du professionnel )
            </li>
            <li>Actions de la DGCCRF (commentaire, contrôle)</li>
          </ul>

          <Typography variant="h4" gutterBottom>4. Autres outils disponibles</Typography>
          ...
          <ul>
            ...
            <li>
              Un système d'abonnement. Il permet actuellement de suivre les signalements relatifs à des départements, des numéros SIRET ou des catégories.
              <br/>La fréquence est soit hebdomadaire (le lundi) soit quotidienne.
            </li>
          </ul>
        </PanelBody>
      </Panel>
